	...
	userId = getRequest()['userId']||getRequest()['userid']
		...
		mui.plusReady(
			...
			if(isAndroid){
				...
				console.log(11)
				img_box.lastChild.src = 'http://yun.janesi.com/janesi-headline/ZQFL/img/appLogo.png'
			}else{
				console.log(img_box.lastChild.src)
				img_box.lastChild.src = 'http://yun.janesi.com/janesi-headline/ZQFL/img/appLogo1.png'
